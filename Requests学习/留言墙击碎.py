...
content = [
    ...
    '找你连麦时你说你在忙工作，每次聊天你都说在忙，你真是一个上进的好女孩，你真好，发现我越来越喜欢这样优秀的你。', '你从来没说过爱我，聊天记录搜索了一下“爱”，唯一的一条是：你好像乡村爱情里的刘能啊。',
...
place = ['火星', '月球', '太空', '地球', 'N78星云', '世界']


def get_params(place: list, content: list) -> dict:
    """
    Randomly get the params.
    :param place:位置数组
    :param content: 输入内容数组
    :return: params
    用来给定params
    """

    params = dict()
    ran_index = random.randint(0, len(place) - 1)

    params['address'] = place[ran_index]
    ran_index = random.randint(0, len(content) - 1)
    params['content'] = content[ran_index]

    return params


def post_request():
    data = get_params(place, content)
    data[
        "__RequestVerificationToken"] = r"t96l2cXUEWEWt-gIUmisQklpzt8liekAum-L_wZFvVAYOeYYc8Qd4lNjH2BDZva6yoZDO7uURuxsh0MUCZZz-gYkrTMuiq2L95zuDSRI1Ao1"
    print(data)
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:76.0) Gecko/20100101 Firefox/76.0",
        "Host": "www.imessagewall.com",
        "Cookie": r"__RequestVerificationToken=a3yh9u-Ej1_DPXegpY_AdmW0AFw1raDOjIH8WexjDZMft_vmbIyWgg3YQsAzAJO1VC3F2PkRovhPSR9a9-zdpQfIEOObFQvJIIkqdsB8kZs1; Hm_lvt_cdd1423ba205724365a0b429875c022b=1590227560; Hm_lpvt_cdd1423ba205724365a0b429875c022b=1590233196"
    }
    req = requests.post(url="https://www.imessagewall.com/Home/LeaveMsg", data=data, headers=headers)
    print(req.text)
